...
function TwidSuit() {
  ...
  useEffect(() => {
        ...
        const addToCart = () => {
          const product = {
            image: "/public/image1.webp",
            id: 9,
            name: "Tweed Formal Blazer",
            price: 8000,
            quantity,
          };
          ...
          <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="flex justify-center">
              <img
                ...
                alt="Tweed Formal Blazer"
                className="w-full max-w-md rounded-lg shadow-lg"
              />
            </div>

            <div className="space-y-6">
              <h1 className="text-3xl font-bold">Twid Formal Blazer</h1>
              <p className="text-2xl font-semibold text-orange-400">Rs 8000</p>
              ...
              <p className="text-lg">
                Total: <span className="font-semibold">Rs {12000 * quantity}</span>
              </p>
