        ...
        <div className="text-white flex justify-center items-center mt-20 p-10">
          <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="space-y-6">
              <h1 className="text-3xl font-bold">Slim Fit Blazer</h1>
              <p className="text-2xl font-semibold text-orange-400">Rs 11000</p>
              ...
              <p className="text-lg">
                Total: <span className="font-semibold">Rs {11000 * quantity}</span>
              </p>
