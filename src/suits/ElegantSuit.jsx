...
function ElegantSuit() {
  ...
  useEffect(() => {
        ...
        const addToCart = () => {
          const product = {
            image: "/public/image6.webp",
            id: 5,
            name: "Elegant 6 Blazer",
            price: 6000,
            quantity,
          };
          ...
          <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="flex justify-center">
              <img
                ...
                alt="Elegant 6 Blazer"
                className="w-full max-w-md rounded-lg shadow-lg"
              />
            </div>

            <div className="space-y-6">
              <h1 className="text-3xl font-bold">Elegant 6 Blazer</h1>
              <p className="text-2xl font-semibold text-orange-400">Rs 6000</p>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center mt-10 space-x-4">
                  ...
                  <button className="border px-4 py-1">Slim Fit</button>
                </div>
              </div>

              <p className="text-lg">
                Total: <span className="font-semibold">Rs {6000 * quantity}</span>
              </p>
              <p className="text-green-400 font-semibold">12 In stock!</p>
        ...
        <div className="text-white p-10">
          <div className="flex justify-between items-center border-b border-gray-700 pb-4">
            <div className="text-gray-400">
              <p>👀 121 People are viewing this right now</p>
              <p>🔥 Sold 44 Products in last 17 Hours</p>
            </div>
